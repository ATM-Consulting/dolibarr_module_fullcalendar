...
$techATM = new \fullcalendar\TechATM($db);

require_once __DIR__ . '/../core/modules/modfullcalendar.class.php';
$moduleDescriptor = new modfullcalendar($db);
